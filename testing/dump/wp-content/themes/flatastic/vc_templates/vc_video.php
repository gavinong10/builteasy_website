...
$animations = $this->getExtraClass(MAD_VC_CONFIG::getCSSAnimation($css_animation));
...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_video_widget wpb_content_element' . $el_class . $animations . $el_class . vc_shortcode_custom_css_class( $css, ' ' ), $this->settings['base'], $atts );
