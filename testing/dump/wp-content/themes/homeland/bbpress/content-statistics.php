...
<dl role="main">
	...
	<dt><?php _e( 'Registered Users', 'codeex_theme_name' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['user_count'] ); ?></strong>
	</dd>

	<dt><?php _e( 'Forums', 'codeex_theme_name' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['forum_count'] ); ?></strong>
	</dd>

	<dt><?php _e( 'Topics', 'codeex_theme_name' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['topic_count'] ); ?></strong>
	</dd>

	<dt><?php _e( 'Replies', 'codeex_theme_name' ); ?></dt>
	<dd>
		<strong><?php echo esc_html( $stats['reply_count'] ); ?></strong>
	</dd>

	<dt><?php _e( 'Topic Tags', 'codeex_theme_name' ); ?></dt>
	<dd>
	...
	<?php if ( !empty( $stats['empty_topic_tag_count'] ) ) : ?>
		...
		<dt><?php _e( 'Empty Topic Tags', 'codeex_theme_name' ); ?></dt>
		<dd>
	...
	<?php if ( !empty( $stats['topic_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Topics', 'codeex_theme_name' ); ?></dt>
		<dd>
			<strong>
	...
	<?php if ( !empty( $stats['reply_count_hidden'] ) ) : ?>
		...
		<dt><?php _e( 'Hidden Replies', 'codeex_theme_name' ); ?></dt>
		<dd>
			<strong>
