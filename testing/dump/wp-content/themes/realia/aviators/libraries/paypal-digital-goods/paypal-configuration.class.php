...
class PayPal_Digital_Goods_Configuration {
	...
	public static function checkout_url() {
        ...
        return ( self::$_cache['environment'] == 'sandbox' ) ? 'https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=' : 'https://www.paypal.com/cgi-bin/webscr?cmd=_express-checkout&token=';
