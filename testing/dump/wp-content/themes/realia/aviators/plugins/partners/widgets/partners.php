...
class Partners_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
			'Partners_Widget',
			__( 'Aviators: Partners', 'aviators' ),
			array(
				'classname'   => 'partners',
				'description' => __( 'Partners', 'aviators' ),
			) );
	}
	...
	public function widget( $args, $instance ) {
		...
		echo View::render( 'partners/widget.twig', array(
			'title'         => apply_filters( 'widget_title', $instance['title'] ),
			'count'         => $instance['count'],
			'partners'      => aviators_partners_get( $instance['count'] ),
