...
class AviatorsLauncherContentImport implements  AviatorsLauncherImporter {
    public function process($filepath) {
        ...
        $importer = new WP_Import_Aviators();

        ob_start();
        $importer->import($filepath);
        $output = ob_get_clean();

        $messages = explode('<br />', $output);
...
class WP_Import_Aviators extends WP_Importer {
...
function aviators_launcher_importer_init() {

    /**
     * WordPress Importer object for registering the import callback
     * @global WP_Import $wp_import
     */
    $GLOBALS['wp_import_aviators'] = new WP_Import_Aviators();
    register_importer( 'wordpress', 'WordPress', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'aviators-importer'), array( $GLOBALS['wp_import_aviators'], 'dispatch' ) );
}
add_action( 'admin_init', 'aviators_launcher_importer_init' );
