<?php
/**
 * This file contains the Thrive_Dash_Api_Sendreach_Response class used in the MailWizzApi PHP-SDK.
 * 
...
/**
 * Thrive_Dash_Api_Sendreach_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author Serban George Cristian <cristian.serban@mailwizz.com>
 * @package MailWizzApi
 * @subpackage Http
 * @since 1.0
 */
class Thrive_Dash_Api_Sendreach_Response extends Thrive_Dash_Api_Sendreach
{
    /**
    ...
    /**
     * @var Thrive_Dash_Api_Sendreach_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var Thrive_Dash_Api_Sendreach_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var Thrive_Dash_Api_Sendreach_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var Thrive_Dash_Api_Sendreach_Request
     */
    public $request;
     ...
     * Contructor.
     * 
     * @param Thrive_Dash_Api_Sendreach_Request $request
     */
    public function __construct(Thrive_Dash_Api_Sendreach_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new Thrive_Dash_Api_Sendreach_Params($params);
        }
