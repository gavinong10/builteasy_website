...
/**
 * Thrive_Dash_Api_Sendreach_ParamsIterator implements an interator for {@link Thrive_Dash_Api_Sendreach_Params}.
 *
 * It allows Thrive_Dash_Api_Sendreach_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class Thrive_Dash_Api_Sendreach_ParamsIterator implements Iterator
{
	/**
