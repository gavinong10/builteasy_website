    ...
    message: '<div class="row">'+
              ...
              '<div class="wp-social-login-widget">'+
                ...
                '<div class="wp-social-login-provider-list">'+
                  ...
                  '<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Facebook&#038;redirect_to='+url+' " title="Connect with Facebook" class="wp-social-login-provider wp-social-login-provider-facebook" data-provider="Facebook">'+
                    '<img alt="Facebook" title="Connect with Facebook" src="http://search.builteasy.com.au/wp-content/plugins/wordpress-social-login/assets/img/32x32/wpzoom//facebook.png" style="margin-right:10px"/>'+
                  '</a>'+

                  '<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Google&#038;redirect_to='+url+' " title="Connect with Google" class="wp-social-login-provider wp-social-login-provider-google" data-provider="Google">'+
                    '<img alt="Google" title="Connect with Google" src="http://search.builteasy.com.au/wp-content/plugins/wordpress-social-login/assets/img/32x32/wpzoom//google.png" style="margin-right:10px"/>'+
                  '</a>'+

                  '<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Twitter&#038;redirect_to='+url+'" title="Connect with Twitter" class="wp-social-login-provider wp-social-login-provider-twitter" data-provider="Twitter">'+
                    '<img alt="Twitter" title="Connect with Twitter" src="http://search.builteasy.com.au/wp-content/plugins/wordpress-social-login/assets/img/32x32/wpzoom//twitter.png" style="margin-right:10px"/>'+
                  '</a>'+
                '</div>'+
              ...
              '<div class="col-md-5">'+
                ...
                '<div class="wp-social-login-provider-list">'+
                  ...
                  '<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Facebook&#038;redirect_to='+url+' " title="Connect with Facebook" class="wp-social-login-provider wp-social-login-provider-facebook" data-provider="Facebook">'+
                    '<img alt="Facebook" title="Connect with Facebook" src="http://search.builteasy.com.au/wp-content/themes/noo-citilights-child/assets/images/fblogin.png" style="margin-right: 10px; margin-bottom: 10px;"/>'+
                  '</a>'+

                  '<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Google&#038;redirect_to='+url+' " title="Connect with Google" class="wp-social-login-provider wp-social-login-provider-google" data-provider="Google">'+
                    '<img alt="Google" title="Connect with Google" src="http://search.builteasy.com.au/wp-content/themes/noo-citilights-child/assets/images/googlelogin.png" style="margin-right: 10px; margin-bottom: 10px;"/>'+
                  '</a>'+

                  /*'<a rel="nofollow" href="http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&#038;mode=login&#038;provider=Twitter&#038;redirect_to='+url+'" title="Connect with Twitter" class="wp-social-login-provider wp-social-login-provider-twitter" data-provider="Twitter">'+
                    '<img alt="Twitter" title="Connect with Twitter" src="http://search.builteasy.com.au/wp-content/themes/noo-citilights-child/assets/images/twitterlogin.png" style="margin-right: 10px; margin-bottom: 10px;"/>'+
                  '</a>'+*/
                '</div>'+
                '<div class="wp-social-login-widget-clearing"></div>'+
              '</div>'+
...
jQuery(document).ready(function(){
  ...
  var Fcurrnet_url= 'http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Facebook&redirect_to='+url+'&redirect_to_provider=true';

  var Gcurrnet_url= 'http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Google&redirect_to='+url+'&redirect_to_provider=true';

  var Tcurrnet_url= 'http://search.builteasy.com.au/wp-login.php?action=wordpress_social_authenticate&mode=login&provider=Twitter&redirect_to='+url+'&redirect_to_provider=true';
