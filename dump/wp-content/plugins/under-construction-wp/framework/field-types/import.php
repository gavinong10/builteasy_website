...
$ajax_url = html_entity_decode(wp_nonce_url('admin-ajax.php?action=seed_ucp_import_settings','seed_ucp_import_settings'));
...
echo "<script>
      jQuery(document).ready(function($) {
        $('#import-settings-btn').click(function() {
            if(confirm(seed_ucp_msgs.import_confirm)){
