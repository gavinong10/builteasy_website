	...
	***********************************************/
	...
	class homeland_Widget_Popular_Posts extends WP_Widget {
		...
		function homeland_Widget_Popular_Posts() {		
			$widget_ops = array('classname' => 'homeland_widget-popular-posts', 'description' => __('Custom widget for popular posts', 'codeex_theme_name'));	
			parent::__construct('Popular', __('Homeland: Popular Posts', 'codeex_theme_name'), $widget_ops);		
		}
			...
			if (empty($title)) $title = false;
				...
				?>
					...
					<div>			
						...
						<p><small><i><?php _e( 'Popular Posts are automatically displayed from blog posts', 'codeex_theme_name' ); ?></i></small></p>		
					</div>
		<?php
				}			
		}
