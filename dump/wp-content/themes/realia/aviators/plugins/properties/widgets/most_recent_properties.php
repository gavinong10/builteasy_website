...
class MostRecentProperties_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
			'MostRecentProperties_Widget',
	...
	public function widget( $args, $instance ) {
		...
		echo View::render( 'properties/widget.twig', array(
			...
			'count'         => $instance['count'],
			'properties'    => aviators_properties_get_most_recent( $instance['count'], $do_shuffle ),
